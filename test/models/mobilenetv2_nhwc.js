  ...
  before(async () => {
    ...
    async function buildLinearBottleneck(
      ...
      const dwise3x3Relu6 = await buildConv(
          conv1x1Relu6, weightsNameArray[1],
